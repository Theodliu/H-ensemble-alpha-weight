...
if __name__ == "__main__":
    ...
    if args.dset == 'office-home':
        names = ['art_0', 'art_1', 'art_2', 'clipart_0', 'clipart_1', 'clipart_2', 'product_0', 'product_1', 'product_2', 'realworld_0', 'realworld_1', 'realworld_2']
        args.class_num = 21
    if args.dset == 'office31':
        names = ['amazon_0', 'amazon_1', 'amazon_2', 'dslr_0', 'dslr_1', 'dslr_2', 'webcam_0', 'webcam_1', 'webcam_2']
        args.class_num = 10
    ...
    args.test_dset_path = folder + args.dset + '/' + '_image_list' + '/' + names[args.t] + '_list.txt' # not used in train
